                                                  ...
                                                  <div className='flex gap-2 p-2'>
                                                       ...
                                                       <div className='grid grid-rows-2 gap-1'>
                                                            ...
                                                            <div className=' text-lg font-semibold   row-span-1 rounded-xl dark:text-primary text-onprimary flex  justify-around '>
                                                                 ...
                                                                 <button className='rounded-xl bg-notif dark:text-primary text-onprimary px-4 py-2 text-lg font-bold' onClick={() => setIsOpen(false)}>BUY</button>

                                                                 <button className='rounded-xl   bg-alert  dark:text-primary text-onprimary px-4 py-2 text-lg font-bold' onClick={() => setIsOpen(false)}>ADD</button>
