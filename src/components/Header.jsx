...
const Header = () => {
  ...
  return (
      <div className='shadow-md w-full fixed top-0 left-0'>
        ...
        <i className={open? 'fa-solid fa-x text-md' : 'fa-solid fa-bars'}></i>
        </div>
  
        <ul className={`md:flex md:items-center dark:bg-primary md:pb-0 pb-12 absolute md:static bg-white md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition ease-in-out duration-150 ${open ? 'top-20 ':'top-[-490px]'}`}>
          {
            Links.map((link)=>(
