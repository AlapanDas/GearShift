               ...
               {!searchdata || searchdata.car.length === 0 ?
                    <div className='flex flex-col justify-center items-center'>
                         ...
                         <div className='flex flex-col justify-center items-center'>
                              ...
                              {document.cookie.includes("filterData") ? <div className='mx-auto grid 2xl:grid-cols-5 xl:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 max-sm:grid-cols-1 gap-6 p-4 justify-items-center py-16'>
